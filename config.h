...
static const char *muttcmd[]          = { "st", "-name", "mutt", "-e", "mutt", NULL };
static const char *weechatcmd[]       = { "st", "-name", "weechat", "-e", "weechat", NULL };
static const char *rangercmd[]        = { "st", "-name", "ranger", "-e", "ranger", NULL };
